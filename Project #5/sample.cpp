...
const char *WINDOWTITLE = { "OpenGL / Project 5" };
...
Display( )
{
	...
	gluLookAt( 30., 30., 45.,     0., 0., 0.,     0., 1., 0. );
	...
	Pattern->SetUniformVariable("uTime", vTime);
	Pattern->SetUniformVariable("ufTime", fTime);
	Pattern->SetUniformVariable("uv_Shader", v_Shader);
	Pattern->SetUniformVariable("uf_Shader", f_Shader);
	Pattern->SetUniformVariable("uvv_Shader", vv_Shader);
	glCallList(BoxList);
	Pattern->Use(0);
	/////////////////////////////////////////////////////////////////////////////////////
